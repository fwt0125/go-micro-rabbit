...
type TaskService interface {
	...
	GetTaskList(ctx context.Context, in *TaskRequest, opts ...client.CallOption) (*TaskResponse, error)
...
func (c *taskService) GetTaskList(ctx context.Context, in *TaskRequest, opts ...client.CallOption) (*TaskResponse, error) {
...
type TaskServiceHandler interface {
	...
	GetTaskList(context.Context, *TaskRequest, *TaskResponse) error
...
func RegisterTaskServiceHandler(s server.Server, hdlr TaskServiceHandler, opts ...server.HandlerOption) error {
	type taskService interface {
		...
		GetTaskList(ctx context.Context, in *TaskRequest, out *TaskResponse) error
...
func (h *taskServiceHandler) GetTaskList(ctx context.Context, in *TaskRequest, out *TaskResponse) error {
